...
@export_group("Scenes")
@export var interact_prompt_scene: PackedScene = preload("res://levels/ui/prompts/prompt_interact_default.tscn")
@export var lamp_prompt_scene: PackedScene = preload("res://levels/ui/prompts/prompt_lamp_default.tscn")
...
func _set_panel_visible(panel: Node, visible_state: bool) -> void:
	if panel == null:
		return
	if panel is CanvasItem:
		panel.visible = visible_state
	elif panel.has_method("set_visible"):
		panel.call("set_visible", visible_state)
